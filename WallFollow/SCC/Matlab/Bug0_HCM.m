    ...
    classdef Bug0_HCM < Navigation_ColorChanged
        ...
        methods
            ...
            function bug = Bug0_HCM(varargin)
                ...
                bug.j = 1;
                bug.step = 1;
                bug.flag = 0; % go toward the goal
            end
    
            function pp = query(bug, start, goal, radius, varargin)
                

                disp('Bug0_HCM is running ... ')
            ...
            function n = next(bug, robot, radius)
                ...
                if (bug.step == 2 && bug.flag == 0) % flag variable is just used to it possible to plot the last hit 
                    ...
                    bug.k = bug.k+1;
                elseif (bug.step == 2 && bug.flag == 1) % it means the hit point is plotted and now step2 can be started
                    % disp(bug.step)
                    % disp('second')
                    bug.flag = 0; 
                    bug.k = bug.k+1;

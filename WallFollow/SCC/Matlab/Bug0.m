    ...
    classdef Bug0 < Navigation_ColorChanged
        ...
        properties(Access=protected)
            ...
            edge    % edge list
            k       % edge index
            flag    % switch between following the obstacle and going toward the goal
        end
    
        methods
    
            function bug = Bug0(varargin)
